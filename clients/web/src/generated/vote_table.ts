 ...
 */
export class VoteTableHandle<TableName extends string> implements __TableHandle<TableName> {
  // phantom type to track the table name
  readonly tableName!: TableName;
  tableCache: __TableCache<Vote>;

  constructor(tableCache: __TableCache<Vote>) {
