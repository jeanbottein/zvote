  ...
  */
  export function getTypeScriptAlgebraicType(): AlgebraicType {
    return AlgebraicType.createProductType([
      ...
      new ProductTypeElement("bad", AlgebraicType.createU32Type()),
      new ProductTypeElement("inadequate", AlgebraicType.createU32Type()),
      new ProductTypeElement("passable", AlgebraicType.createU32Type()),
      new ProductTypeElement("fair", AlgebraicType.createU32Type()),
